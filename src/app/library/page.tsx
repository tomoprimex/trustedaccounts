    ...
    <main className="min-h-screen bg-[#f5f7fb] px-2 py-4 sm:px-4 sm:py-6">
      <div className="mx-auto max-w-3xl">
                  ...
                  <div className="relative bg-white/80 backdrop-blur-xl rounded-xl p-2.5 border border-white/30 shadow-sm transition hover:shadow-md">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-blue-600 to-blue-600 flex items-center justify-center flex-shrink-0">
        ...
        <div className="mt-4">
          <Link 
            href="/dashboard"
            className="inline-flex items-center gap-1 text-[10px] font-medium text-blue-600 hover:text-blue-500 transition-colors"
          >
